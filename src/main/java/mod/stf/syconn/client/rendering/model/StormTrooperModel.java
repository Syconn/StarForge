...
public class StormTrooperModel extends HumanoidModel<StormTrooper> {

    public static final String BODY = "body";

    public static ModelLayerLocation STORMTROOPER = new ModelLayerLocation(new ResourceLocation(Reference.MOD_ID, "stormtrooper"), BODY);
    ...
    public StormTrooperModel(ModelPart part) {
        super(part);
    }

    public void prepareMobModel(StormTrooper pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
     ...
     */
    public void setupAnim(StormTrooper pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
