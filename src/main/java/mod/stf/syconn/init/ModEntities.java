...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ThrownLightsaber>> LIGHTSABER = REGISTER.register("lightsaber", () -> EntityType.Builder.<ThrownLightsaber>of(ThrownLightsaber::new, MobCategory.MISC).sized(0.25F, 0.25F).setTrackingRange(100).setUpdateInterval(1).fireImmune().setShouldReceiveVelocityUpdates(true).build("lightsaber"));
