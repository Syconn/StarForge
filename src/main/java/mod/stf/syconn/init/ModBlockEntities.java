...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NavBE>> NAV_BE = REGISTER.register("nav_computer", () -> BlockEntityType.Builder.of(NavBE::new, ModBlocks.NAV_COMPUTER.get()).build(null));
}
